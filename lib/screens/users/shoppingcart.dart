          ...
          Container(width: MediaQuery.of(context).size.width,height: MediaQuery.of(context).size.height*0.12,child :
           ...
           Container(height:MediaQuery.of(context).size.height *0.85 ,child:downloadcart?Container(child: Center(child: CircularProgressIndicator(),),) :products.length==0 ?Container(child: Center(child: Text("لا يوجد أي منتج في عربة التسوق "),),) : ListView(children: [
             ...
             Directionality(textDirection: TextDirection.rtl,
               child: Container(
                 child: Container(margin: EdgeInsets.only(top: MediaQuery.of(context).size.height*0.01,),width: MediaQuery.of(context).size.width,height: MediaQuery.of(context).size.height*0.08,child: Column(children: [
                   Container(margin: EdgeInsets.only(left: MediaQuery.of(context).size.width*0.1,top: MediaQuery.of(context).size.height*0.02,right:MediaQuery.of(context).size.width*0.1 ) ,child : Row(children: [Expanded(child:Container(child:
                   Text("اكمال البيانات",style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold))),)],)),
                 ],),),
               ),
             ),
             Container(
               child:  Container(margin: EdgeInsets.only(top: 1),color: Colors.white,width: MediaQuery.of(context).size.width,child: Column(children: [
                 Directionality(textDirection: TextDirection.rtl,
